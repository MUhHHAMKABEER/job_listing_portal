        ...
        <div class="col-md-8 col-xl-9">
            <div class="card">
                ...
                <div class="card-body h-100">
                    ...
                    <form action="{{ route('jsprofile') }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="card-body h-100">
                    <form action="{{ route('jspassword') }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="col-12">
                            <div class="mb-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    <div id="picture-section">
                        @if ($user->picture)
                            <img src="{{ asset('template/img/jsphotos/' . $user->picture) }}"
                    ...
                    <div>
                        <form action="{{ route('jspicture') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="mb-3">
